...
from app.routes.api_v1.endpoints import auth, pdf_processing, health_check, google_auth
...
app.include_router(google_auth.router, prefix="/api/v1/auth/google", tags=["Google Auth"])
